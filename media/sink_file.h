...
#ifndef __STREAMING_SINK_FILE_H__
#define __STREAMING_SINK_FILE_H__
...
// A file sink component.
class FileSink : public Component {
 public:
  FileSink(const char* name, bool sync, const char* location);
...
#endif   // __STREAMING_SINK_FILE_H__
