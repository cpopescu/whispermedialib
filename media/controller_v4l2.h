...
#ifndef __STREAMING_CONTROLLER_V4L2_H__
#define __STREAMING_CONTROLLER_V4L2_H__
...
class V4L2SourceController : public Controller {
 public:
  V4L2SourceController();
 ...
 protected:
  ...
  virtual bool DoSetValue(ControlID id, ControlChannel* channel, int value);
 ...
 private:
  ...
  // Maps a generic control ID to the internal, V4L2 dependent control id
  int MapControlID(ControlID id, bool* read_only = NULL, bool* relative = NULL);
};
}  // namespace media

#endif   // __STREAMING_CONTROLLER_V4L2_H__
