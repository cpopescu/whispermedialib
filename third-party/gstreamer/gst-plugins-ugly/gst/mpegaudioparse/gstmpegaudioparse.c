...
enum
{
  ...
  ARG_BIT_RATE,
  /*
   * WHISPERCAST BEGIN: do not automatically adjust timestamps...
  */
  ARG_ADJUST_TIMESTAMPS
  /*
   * WHISPERCAST END: do not automatically adjust timestamps...
  */
      /* FILL ME */
};
...
gst_mp3parse_class_init (GstMPEGAudioParseClass * klass)
{
   ...
   * WHISPERCAST BEGIN: do not automatically adjust timestamps...
  */
  g_object_class_install_property (G_OBJECT_CLASS (klass), ARG_ADJUST_TIMESTAMPS,
      g_param_spec_boolean ("adjust_timestamps", "Adjust timestamps", "Adjust timestamps",
...
gst_mp3parse_reset (GstMPEGAudioParse * mp3parse)
{
   ...
   * WHISPERCAST BEGIN: do not automatically adjust timestamps...
  */
  mp3parse->adjust_timestamps = FALSE;
  /*
   * WHISPERCAST END: do not automatically adjust timestamps...
  */
    ...
    guint mode, guint crc)
{
   ...
   * here */
  /*
   * WHISPERCAST ORIGINAL: do not automatically adjust timestamps...
  if (GST_CLOCK_TIME_IS_VALID (mp3parse->pending_ts)) {
  */
  /*
   * WHISPERCAST BEGIN: do not automatically adjust timestamps...
  */
  if (mp3parse->adjust_timestamps && GST_CLOCK_TIME_IS_VALID (mp3parse->pending_ts)) {
  /*
   * WHISPERCAST END: do not automatically adjust timestamps...
  */
    ...
    const GValue * value, GParamSpec * pspec)
{
  ...
  switch (prop_id) {
     ...
     * WHISPERCAST BEGIN: do not automatically adjust timestamps...
    */
    case ARG_ADJUST_TIMESTAMPS:
      src->adjust_timestamps = g_value_get_boolean (value);
      break;
    /*
     * WHISPERCAST END: do not automatically adjust timestamps...
    */
    ...
    GParamSpec * pspec)
{
  ...
  switch (prop_id) {
    ...
    */
    case ARG_ADJUST_TIMESTAMPS:
      g_value_set_boolean (value, src->adjust_timestamps);
      break;
    /*
     * WHISPERCAST END: do not automatically adjust timestamps...
    */
