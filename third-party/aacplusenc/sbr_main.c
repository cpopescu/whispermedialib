...
static __thread struct ENV_CHANNEL EnvChannel[MAX_CHANNELS];
static __thread struct SBR_ENCODER sbrEncoder;
static __thread SBR_QMF_FILTER_BANK SynthesisQmfBank;
static __thread struct PS_ENC psEncoder;
                       ...
                       )
{
  ...
  /* THREAD SAFETY */
  PsBuf2 = &mdctDelayBuffer[BLOCK_SWITCHING_OFFSET];
  
  PsBuf4 = &sbr_toncorrBuff[5*NO_OF_ESTIMATES*MAX_FREQ_COEFFS];
  PsBuf5 = &sbr_toncorrBuff[5*NO_OF_ESTIMATES*MAX_FREQ_COEFFS + PS_BUF4_SIZE];
